...
It's even possible to omit a Georeference Annotation and fully specify the projected transformation using the options. GCPs can be specified using one of the [supported GCP file formats](#gcp-file-formats). With a file `path/to/gcps.txt` that contains four GCPs:
...
| Option                                           | Description                                                                                                                                                                    | Default      |
|:-------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------|
| `-g, --gcps <filename>`                          | Filename of GCP file, see the [supported GCP file formats](#gcp-file-formats). These GCPs take precedence over the GCPs from the Georeference Annotation (or Georeferenced Map).                                                                               |              |
...
The following GCP file formats are supported:
