...
describe('allmaps annotation', () => {
  test('should display help when no arguments are provided', () => {
    expect(() => execFilename('annotation')).to.throw(helpMessage('annotation'))
  })

  test('should display help when incorrect command is provided', () => {
    expect(() => execFilename('annotation incorrect')).to.throw(
...
describe('allmaps annotation generate', () => {
  test("should read georeference data in Allmaps' internal format from a file and convert it to a Georeference Annotation", () => {
  ...
  test("should read georeference data in Allmaps' internal format from a file, apply a custom transformation type and and convert it to a Georeference Annotation", () => {
  ...
  test("should read georeference data in Allmaps' internal format from the standard input and convert it to a Georeference Annotation", () => {
    const expected = readFileJson('output/annotations/5610333850638ae2.json')
    const output = execJson(
      'annotation generate',
  ...
  test('should read a Georeference Annotation from the standard input and overwrite the gcps and resource id to create a new annotation, with gcp resource scaling if specified', () => {
    const expected = readFileJson(
...
describe('allmaps annotation parse', () => {
  test("should read a Georeference Annotation from a file and convert it to Allmaps' internal format", () => {
  ...
  test("should read a Georeference Annotation from the standard input and convert it to Allmaps' internal format", () => {
    const expected = readFileJson('output/maps/7a69f9470b49a744.json')
    const output = execJson(
      'annotation parse',
  ...
  test("should read a Georeference Annotation from a file, apply custom GCPs from another Georeference Annotation and convert it to Allmaps' internal format", () => {
    const expected = readFileJson(
  ...
  test("should read a Georeference Annotation from a file, apply custom QGIS GCPs and convert it to Allmaps' internal format", () => {
    const expected = readFileJson(
  ...
  test("should read a Georeference Annotation from a file, apply custom QGIS GCPs infering their projection, and convert it to Allmaps' internal format", () => {
    const expected = readFileJson(
  ...
  test("should read a Georeference Annotation from a file, apply custom ArcGIS CSV GCPs and convert it to Allmaps' internal format", () => {
    const expected = readFileJson(
      'output/maps/7a69f9470b49a744-custom-gcps.json'
    )
    const output = execJson(
  ...
  test("should read a Georeference Annotation from a file, apply custom ArcGIS CSV GCPs with specified projection and convert it to Allmaps' internal format", () => {
    const expected = readFileJson(
      'output/maps/7a69f9470b49a744-custom-gcps-resource-crs.json'
    )
    const output = execJson(
...
describe('allmaps annotation svg', () => {
  test('should read a Georeference Annotation from the standard input and convert its resource mask to an SVG polygon', () => {
...
describe('allmaps annotation gcps', () => {
  test('should read a Georeference Annotation from the standard input and convert its gcps to a GDAL GCP file', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to a GDAL GCP file, with overwritable projection', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an QGIS GCP file, with overwritable projection', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS CSV GCP file, with overwritable projection', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS TSV GCP file', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS TSV GCP file, with gcp resource origin set by the options', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS TSV GCP file, with gcp resource y axes orientation set by the options', () => {
    const expected = readFile(
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS TSV GCP file, with gcp resource width and height set by the options', () => {
  ...
  test('should read a Georeference Annotation from the standard input and convert its gcps to an ArcGIS CSV GCP file, with resourceCrs included and applied', () => {
