...
* A new version of **Allmaps Viewer** with an improved background map, a new 'list' view and advanced functionality for analyzing and comparing maps.
...
Applications use the GNU GPLv3 license; packages use the MIT License. All georeference annotations generated through Allmaps Editor or otherwise added to the Allmaps database are licensed as CC0 (public domain) and published daily as a data dump. Allmaps’ packages can be used independently of Allmaps’ infrastructure, i.e. it’s possible to host your own annotations (using different licenses).
...
For more information about Allmaps and listed benefits, please contact the Allmaps team at [hello@allmaps.org](mailto:hello@allmaps.org) or through the \#allmaps channel in the IIIF Slack.

To indicate your organisation’s interest in a membership top-up, please reach out to the IIIF Consortium staff at [staff@iiif.io](mailto:staff@iiif.io).
