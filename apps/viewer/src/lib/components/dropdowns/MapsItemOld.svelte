...
>
  <div>
    ...
    <label
      for={checkboxId}
      class="relative inline-block w-32 h-32 p-2 text-gray-500 bg-white border-2 border-gray-200 rounded cursor-pointer peer-checked:border-blue-600 hover:text-gray-600 peer-checked:text-gray-600 hover:bg-gray-50 select-none"
    >
      <div
