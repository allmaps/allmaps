...
import type { Rcp } from '../src/types.js'
...
describe('Create attachments from RCPs', () => {
  test(`should throw when less then two maps`, () => {
    expect(() =>
      AttachedTransformation.fromGeoreferencedMaps([georeferencedMap0], rcps)
    ).to.throw()
  })

  test(`should throw when there are no RCPs corresponding to any map`, () => {
    expect(() =>
  ...
  test(`should throw when there are no RCPs that occure at least two times`, () => {
    expect(() =>
      AttachedTransformation.fromGeoreferencedMaps(
        [georeferencedMap0, georeferencedMap1],
        [...rcps0]
  ...
  test(`should create a stape when two RCPs with the same id`, () => {
  ...
  test(`should create multiple stapes when more then two RCPs with the same id`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
...
describe('Coefs matrix for two maps', () => {
  test(`should build the correct destination points arrays`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [georeferencedMap0, georeferencedMap1],
      rcps11,
...
describe('Process transformation type', () => {
  test(`should create create a different coefs matrix depending on the transformation type`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [georeferencedMap0, georeferencedMap1],
      rcps11,
...
describe('Coefs matrix for more then two maps', () => {
  test(`should build the right coefs matrix`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [georeferencedMap0, georeferencedMap1, georeferencedMap2],
      rcps11,
      { transformationType: 'polynomial' }
...
describe('Solve two maps attached together and evaluate points', () => {
  test(`should return maps with extra gcps`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to not average out attachments`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to evaluate source points`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to re-evaluate gcps`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to remove existing gcps`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to remove existing gcps and work with multiple annotations`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
  ...
  test(`should have an option to evaluate attachment source control points`, () => {
    const attachedtransformation = AttachedTransformation.fromGeoreferencedMaps(
      [
        georeferencedMap0,
        georeferencedMap1,
