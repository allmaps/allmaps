...
function getThumbnailSize(imageSize, containerSize, mode = 'cover') {
...
export function getThumbnail(sizes, tileZoomLevels, supportsAnyRegionAndSize, imageSize, containerSize, mode = 'cover') {
