export function getIiifTile({ width: imageWidth, height: imageHeight }, zoomLevel, column, row) {
...
function getDefaultTileset({ width: imageWidth, height: imageHeight }, tileWidth = 256) {
