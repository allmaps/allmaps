...
(thanks to the register() function) and constructs a new Projection type (defined in
...
### `WarpedMapLayer#setMapsOptions(mapIds, mapsOptions, animationOptions)`
...
* `options?` (`object | Partial<WebGL2RenderOptions> | undefined`)
  * Options to set
