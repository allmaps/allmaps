...
describe('Polynomial transformation, order 1', async () => {
  const transformer = new GCPTransformer(transformGcps3, 'polynomial')
  const input = [100, 100]
...
describe('Polynomial transformation, order 2', async () => {
  const transformer = new GCPTransformer(transformGcps6, 'polynomial2')
...
describe('Polynomial transformation, order 3', async () => {
  const transformer = new GCPTransformer(transformGcps10, 'polynomial3')
...
describe('Projective transformation', async () => {
  const transformer = new GCPTransformer(transformGcps6, 'projective')
  const input = [1000, 1000]
