...
const rectangleOnGrid: Rectangle = [
  [0, 0],
  [0, 2],
  [2, 2],
  [2, 0]
...
describe('Rectangle', async () => {
  test(`should work for average polygons with no distance provided`, () => {
    const output = [
      [
        [0.592, 0.953],
        [0.304, 2.394],
  ...
  test(`should work for average polygons with a distance provided`, () => {
    const output = [
      [
        [1.304, 1.232],
  ...
  test(`should remove sharp triangles using minimumTriangleAngle`, () => {
    const output = [
      [
        [1.304, 1.232],
        [1.4655588463411926, 0.6034795070965593],
  ...
  test(`should work with rectangles on grid (collinearity check) with no distance provided`, () => {
    const output = [
      [
        [0, 0],
        [0, 2],
  ...
  test(`should work provide the same result when using unique points`, () => {
